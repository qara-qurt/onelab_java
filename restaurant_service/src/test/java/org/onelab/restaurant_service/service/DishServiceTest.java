...
//        DishDocument dish = DishDocument.builder().name("Pasta").price(1200.0).build();
//
//        when(dishRepository.findByName("Pasta")).thenReturn(Optional.empty());
//        when(dishRepository.save(dish)).thenReturn(DishDocument.builder().id("123").name("Pasta").price(1200.0).build());
//
...
//        DishDocument dish = DishDocument.builder().name("Pizza").price(1500.0).build();
//
...
//        DishDocument dish = DishDocument.builder().id("456").name("Salad").price(800.0).build();
//
...
//        DishDocument dish = DishDocument.builder().name("Burger").price(1300.0).build();
//
...
//        DishDocument dish = DishDocument.builder().id("999").name("Soup").price(500.0).build();
//
//        when(dishRepository.findById("456")).thenReturn(Optional.of(dish));

...
class UserServiceTest {
    ...
    void withDrawBalance_shouldFail_whenInsufficientBalance() {
        User userWithLowBalance = User.builder().id("1").balance(50.0).build();
    ...
    void withDrawBalance_shouldSuccess_whenEnoughBalance() {
        User user = User.builder().id("1").balance(200.0).build();
    ...
    void fillBalance_shouldSucceed_whenUserExists() {
        User user = User.builder().id("1").balance(50.0).build();
